...
<section class="col-8 container-fluid ">
	...
	<div id="title" class="col-12 align-self-center">
			...
			<div class="card">
				<div class="row g-0">
					<div class="col-4 col-sm-3">
						<img
							src="${pageContext.request.contextPath }/upload/${top.pro_pic}"
							height="180" width="180">
					</div>
					<div class="col-8 col-sm-9 protext">
						<h4><a href="${pageContext.request.contextPath }/proView/pro_no/${top.pro_no}">${top.pro_name }</a></h4><br>
						<p><a href="${pageContext.request.contextPath }/proView/pro_no/${top.pro_no}">${top.pro_addr }</a></p>
						<div class="else_info row">
							<div class="col-9">
								<c:if test="${top.rv_total != 0 }">
									<span>별점: <span class="red_b">${top.star_avg}</span> </span><span class="f14">(후기 ${top.rv_total})</span>
								</c:if>
								<c:if test="${top.rv_total == 0 }">
